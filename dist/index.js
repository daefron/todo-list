const projectMaker = (() => {
  ...
  function Todo(project, position, title, description, dueDate, priority, checked) {
  ...
  projectHolder.push(new Project(0, "test project 1", []));
  projectHolder
    .at(0)
    .todoHolder.push(
      new Todo(
  ...
  console.log(projectHolder.at(0).todoHolder);
  console.log(projectHolder.at(0));
  ...
  todoToDisplay(projectHolder.at(0).todoHolder[0]);
})();
